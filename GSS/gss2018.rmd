...
chisqtestGC(tab1)
```
The P-value for the chisq test is 0.2 < 0.05 so We reject the null hypothesis and conclude we have evidence to support the contention that gun owner ship and wether on favors capital punishment are related.
